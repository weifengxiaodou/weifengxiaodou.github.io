...
d3.csv("datasets/cities-sm.csv").then(function(data){
    ...
    data.forEach( function(d) {
        ...
        //the plus sign is unary operator(to push a string to number)
        //d is 
        //there is a space in "land space", so we access it in a different way
        //forEach is a loop
